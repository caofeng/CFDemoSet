 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(241,241,241,1)

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor rgba(100,100,100,1)
...
/**
 *  整个解锁View的Center.y值 在当前屏幕的1/2位置
 */
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState rgba(100,100,100,1)
 ...
 *  密码错误最大次数
 */
#define gestureTextGestureVerifyMaxErrorNum 5

/**
 *  密码重试机会
 */

#define gestureTextGestureVerifyRestNum(num) [NSString stringWithFormat:@"您还有%ld次机会",gestureTextGestureVerifyMaxErrorNum - num]
